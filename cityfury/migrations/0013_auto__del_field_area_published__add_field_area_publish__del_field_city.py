...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.publish'
        db.add_column(u'cityfury_area', 'publish',
        ...
        # Adding field 'City.publish'
        db.add_column(u'cityfury_city', 'publish',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Area.publish'
        db.delete_column(u'cityfury_area', 'publish')
        ...
        # Deleting field 'City.publish'
        db.delete_column(u'cityfury_city', 'publish')
