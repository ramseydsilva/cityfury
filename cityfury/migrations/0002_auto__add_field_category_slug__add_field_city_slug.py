...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'cityfury_category', 'slug')

        # Deleting field 'City.slug'
        db.delete_column(u'cityfury_city', 'slug')
