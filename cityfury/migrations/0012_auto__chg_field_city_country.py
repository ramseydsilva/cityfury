...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cityfury_city', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cityfury.Country'], null=True))

    def backwards(self, orm):

        # Changing field 'City.country'
        db.alter_column(u'cityfury_city', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['cityfury.Country']))
