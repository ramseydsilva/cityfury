...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cityfury_post', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cityfury.City'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.city'
        db.delete_column(u'cityfury_post', 'city_id')
