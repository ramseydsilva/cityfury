...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cityfury_post', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cityfury.Area'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'cityfury_post', 'area_id')
