...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.uploaded_date'
        db.delete_column(u'cityfury_post', 'uploaded_date')

        # Adding field 'Post.created_date'
        db.add_column(u'cityfury_post', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 8, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Post.uploaded_date'
        db.add_column(u'cityfury_post', 'uploaded_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Post.created_date'
        db.delete_column(u'cityfury_post', 'created_date')
