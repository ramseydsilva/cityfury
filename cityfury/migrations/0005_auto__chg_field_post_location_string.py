...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.location_string'
        db.alter_column(u'cityfury_post', 'location_string', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Post.location_string'
        db.alter_column(u'cityfury_post', 'location_string', self.gf('django.db.models.fields.CharField')(default='', max_length=500))
