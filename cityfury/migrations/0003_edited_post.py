...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cityfury_post', 'title')

        # Adding field 'Post.caption'
        db.add_column(u'cityfury_post', 'caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'Post.location_string'
        db.add_column(u'cityfury_post', 'location_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'cityfury_post', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Post.caption'
        db.delete_column(u'cityfury_post', 'caption')

        # Deleting field 'Post.location_string'
        db.delete_column(u'cityfury_post', 'location_string')
    ...
    models = {
        ...
        u'cityfury.post': {
            ...
            'location_string': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
